...
async function getHelpMenu({ client, guild }) {
  ...
  let components = [];
  components.push(
    new ButtonBuilder().setCustomId("previousBtn").setEmoji("Previours Page").setStyle(ButtonStyle.Secondary).setDisabled(true),
    new ButtonBuilder().setCustomId("nextBtn").setEmoji("Next Page").setStyle(ButtonStyle.Secondary).setDisabled(true)
  );
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      "**About Me:**\n" +
        ...
        "A bot which has Almost **EVERY* needs for a server\n\n" +
